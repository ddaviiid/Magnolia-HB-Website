...
const reasons = [
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <path d="M14 3L3 11V25H11V17H17V25H25V11L14 3Z" stroke="#3EB684" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <circle cx="14" cy="14" r="10" stroke="#3EB684" strokeWidth="1.5"/>
        <path d="M10 14L12.5 17L18 11" stroke="#3EB684" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <rect x="3" y="6" width="22" height="19" rx="2" stroke="#3EB684" strokeWidth="1.5"/>
        <line x1="3" y1="11" x2="25" y2="11" stroke="#3EB684" strokeWidth="1.5"/>
        <line x1="9" y1="3" x2="9" y2="9" stroke="#3EB684" strokeWidth="1.5" strokeLinecap="round"/>
        <line x1="19" y1="3" x2="19" y2="9" stroke="#3EB684" strokeWidth="1.5" strokeLinecap="round"/>
        <rect x="8" y="16" width="5" height="4" rx="1" fill="#3EB684" opacity="0.5"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <path d="M14 3L5 8V18C5 22 9 25 14 27C19 25 23 22 23 18V8L14 3Z" stroke="#3EB684" strokeWidth="1.5" strokeLinejoin="round"/>
        <path d="M10 14L12.5 17L18 12" stroke="#3EB684" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
